...
class OptionsMeta(type):
    ...
    # def _create_(mcs: type, clsname: str, bases: 'Union[type, Tuple[type, ...]]', classdict: 'Dict'):
    ...
    #     options: 'Optional[List[OptionAbstract]]',
    #     *bases: type
    # ) -> 'OptionsBase':
    #     if
    #     return cls.__new__(cls, value)
    #
    # def __new__(mcs: type, clsname: str, bases: 'Union[type, Tuple[type, ...]]', classdict: 'Dict'):
...
class BaseFlags(OptionsBase):

    @staticmethod
    def valid_options() -> 'List[Union[Toggle, Prefixed, KWOption, ListOption]]':
        return [
            Toggle('st-flag', '--st-flag'),
            Toggle('nd-flag', '--nd-flag'),
        ]


class SomeOptions(BaseFlags, OptionsBase):

    @staticmethod
    def valid_options() -> 'List[Union[Toggle, Prefixed, KWOption, ListOption]]':
        return [
            KWOption('kw-mechanism', '--kw-mechanisms'),
            KWOption('kw-username', '--kw-username'),
        ]


class InspectionClass(SomeOptions, BaseFlags):
